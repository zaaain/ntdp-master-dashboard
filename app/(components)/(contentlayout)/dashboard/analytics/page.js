...
import {
  ...
  Visitors,
  Visitorsource,
} from "@/shared/data/dashboard/analyticdata";
...
import {
  ...
  Totalrevenue1,
  Trading,
} from "@/shared/data/dashboard/cryptodata";
import {
  Bar,
  Bubble,
  Doughnut,
...
const Analytics = () => {
  ...
  return (
    <Fragment>
              ...
              <Card className="custom-card">
                ...
                <Card.Body>
                  <div className="d-flex flex-column">
                    {/* Text Section */}
                    <div style={{}}>
                      <span className="d-block text-muted mb-3 text-center">
                        Products Launched
                      </span>
            ...
            <Col xl={12}>
              <Card className="custom-card">
                ...
                <div className="card-header">
                  <div className="card-title">Top 5 Industries</div>
                </div>
              ...
              <Card className="custom-card">
                ...
                <Card.Body>
                  <div className="d-flex align-items-center justify-content-center">
                    ...
                    {/* <div>
                                            <span className="avatar bg-primary-transparent svg-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none" /><path d="M12 6c-3.79 0-7.17 2.13-8.82 5.5C4.83 14.87 8.21 17 12 17s7.17-2.13 8.82-5.5C19.17 8.13 15.79 6 12 6zm0 10c-2.48 0-4.5-2.02-4.5-4.5S9.52 7 12 7s4.5 2.02 4.5 4.5S14.48 16 12 16zm0-7c-1.38 0-2.5 1.12-2.5 2.5S10.62 9 12 9s2.5 1.12 2.5 2.5S13.38 14 12 14z" /></svg>
                                            </span>
                                        </div> */}
                  </div>
                </Card.Body>
      ...
      <Row className="line-of-investment justify-content-center m-auto mb-4">
        {[
          {
            title: "GDP Contribution",
            images: [
              "/assets/images/finance/first.jpg",
              "/assets/images/finance/first1.jpg",
            ],
            layout: "column",
          },
          {
            title: "Job creation",
            images: [
              "/assets/images/finance/second.jpg",
              "/assets/images/finance/second.jpg",
            ],
            layout: "column",
          },
          {
            title: "Tech Unicorns",
            images: [
              "/assets/images/finance/third.jpg",
              "/assets/images/finance/third.jpg",
              "/assets/images/finance/third.jpg",
            ],
            layout: "row",
          ...
          {
            title: "Programs",
            listItems: ["AIM", "NEXTERA"],
          },
          {
            title: "Programs",
            listItems: ["Loan Guarantee", "LendTech"],
          },
        ].map((item, index) => (
          <Col
            key={index}
          ...
          >
            <h3
              className="fw-semibold text-center py-2 mb-2"
              style={{ display: "flex", justifyContent: "center" }}
            >
              {item.title}
            </h3>
            <Card className="custom-card h-100" style={{ minHeight: "200px" }}>
              <div className="top-left"></div>
              <div className="top-right"></div>
              <div className="bottom-left"></div>
              <div className="bottom-right"></div>

              <Card.Body style={{ overflowY: "auto", maxHeight: "180px" }}>
                <div
                  className={`d-flex ${
                    item.layout === "column" ? "flex-column" : "flex-wrap"
                  ...
                  {item.images ? (
                    item.images.map((image, i) => (
                      <div
                        ...
                        style={{
                          flex:
                            item.layout === "column" ? "0 0 100%" : "0 0 50%",
                        }}
                      >
                        <img
                          src={image}
                    ...
                    <ul className="text-center list-unstyled">
                      {item.listItems.map((listItem, i) => (
                        <li
                          key={i}
                          style={{ listStyleType: "disc", textAlign: "center" }}
                        >
                          {listItem}
                        </li>
                      ))}
        ...
        {[
          {
            ...
            data: [
              {
                value: "SAR 400 Mn",
                label: "Cumulative Investment closed after relocation",
              },
              {
                value: "32",
                label: "Founders, co-Founders and C-Level relocated",
              },
                    ...
                    {item.data.map((block, i) => (
                      <div key={i} className="mb-3">
                        ...
                        {i < item.data.length - 1 && (
                          <div className="fs-3 text-white">⬇️</div>
                        )}
                      </div>
                    ))}
                  </div>
            ...
            {[
              {
                ...
                details: [
                  "(841 Mn debt instruments to startups)",
              ...
              },
              {
                ...
                details: [
                  "797 Startups Created",
                  "2,197 Entrepreneurs supported",
                  "154",
                ],
              },
              {
                ...
                <Card className="custom-card text-center flex-grow-1">
                  ...
                  <Card.Body>
                    {item.highlights.map((highlight, i) => (
                      <h6
                        key={i}
                        className="card-title fw-medium mb-2"
      ...
      <Row>
        <Col xl={9}>
          <Card className="custom-card">
            ...
            <div className="bottom-right"></div>
            <div className="card-header">
              <div className="card-title">Product Spending</div>
            </div>
            <Card.Body>
              <div id="users-report">
                <Userreport />
        ...
        {[
          ...
          >
            ...
            <img
              ...
              }/assets/images/brand-logos/${item.image}`}
              alt={item.title}
